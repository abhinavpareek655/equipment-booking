      ...
      <div className="space-y-6 text-center">
        ...
        <div className="mx-auto max-w-2xl mt-12 p-6 bg-gray-50 rounded-lg">
          ...
          <p className="text-gray-600">
            The DBT BUILDER project provides advanced research equipment for faculty, researchers, and students at the
            School of Life Sciences, Central University of Rajasthan. This booking system ensures systematic, fair, and
